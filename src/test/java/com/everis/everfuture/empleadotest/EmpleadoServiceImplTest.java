...
import com.everis.everfuture.service.EmpleadoServiceImpl;
...
public class EmpleadoServiceImplTest {
    ...
    void buscarTodos(){
        // GIVEN:
            Empleado e1 = new Empleado(username+'1', "nombre", "ape", 3500);
            Empleado e2 = new Empleado(username+'2', "nombre", "ape", 3500);
    ...
    void buscarPorNombreTest(){
        // GIVEN:
            ...
            Empleado e1 = new Empleado(username+'1', nombre, "ape", 3500);
            Empleado e2 = new Empleado(username+'2', "nombre2", "ape", 3500);
