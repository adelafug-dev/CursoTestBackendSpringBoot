...
import com.everis.everfuture.controller.ClienteRestController;
...
public class ClienteRestControllerTest {
    ...
    void modificarClienteTest() {
        ...
        assertEquals(nuevoNombre, rec.getBody().getName(), "El nombre ha cambiado");

        Optional<Cliente> oc2 = dao.findById(DNITEST);
        assertTrue(oc2.isPresent(), "El cliente debe estar ya insertado");
        assertEquals(nuevoNombre, oc2.get().getName(), "El nombre ha cambiado");
